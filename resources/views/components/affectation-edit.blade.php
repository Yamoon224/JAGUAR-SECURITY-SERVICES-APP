                ...
                <div class="modal-body">
                    <div class="row g-2">                        
                        <div class="col-12">     
                            ...
                            <div class="position-relative input-icon mb-3">
                                <input type="number" class="form-control" name="price" placeholder="@lang('lang.amount')" value="{{ $affectation->price }}" required />
                            ...
                            <div class="position-relative input-icon mb-2">
                                <input type="number" class="form-control" placeholder="@lang('lang.oraspc')" value="{{ $affectation->oraspc }}" name="oraspc" />
                                <span class="position-absolute top-50 translate-middle-y"><i class='bx bx-money'></i></span>
                            </div>
                            <div class="position-relative input-icon mb-3">
