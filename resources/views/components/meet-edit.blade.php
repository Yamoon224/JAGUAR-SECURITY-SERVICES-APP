    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h5 class="modal-title text-white"><i class="bx bx-user-plus"></i> @lang('lang.meet')</h5>
                    ...
                    <div class="row g-3">                        
                        <div class="col-12">   
                            <div class="position-relative input-icon mb-3">
                                <input type="text" class="form-control" name="object" placeholder="@lang('lang.object') *" value="{{ $meet->object }}" required>
                                <span class="position-absolute top-50 translate-middle-y"><i class='bx bx-message-edit'></i></span>
                            </div>
                            <div class="position-relative input-icon mb-3">
                                <textarea class="form-control" name="points" placeholder="@lang('lang.points') *" style="resize: none" required>{{ $meet->points }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="uploadfile" type="file" name="file_path" accept=".pdf" multiple>
                            </div>   
                        </div>
                    </div>
                </div>
