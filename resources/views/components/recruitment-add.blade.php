<div class="modal fade" id="recruitment-add" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('recruitments.store') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-12">
                            <label for="">@lang('lang.title') <span class="text-danger">*</span></label>
                            ...
                            <div class="position-relative input-icon mb-3">
                                <input type="date" class="form-control" name="start_date" placeholder="@lang('lang.start_date') *" required>
                            ...
                            <div class="position-relative input-icon mb-3">
                                <input type="date" class="form-control" name="end_date" placeholder="@lang('lang.end_date') *" required>
                                <span class="position-absolute top-50 translate-middle-y"><i class='bx bx-calendar'></i></span>
                            </div>
                            ...
                            <div class="position-relative mb-3">
                                <textarea class="form-control" name="description" id="editor" placeholder="@lang('lang.description')" style="resize: none" required></textarea>
                            </div>
